 ...
 */
MPU6050::MPU6050(int32_t sensorID) {
    _sensorID = sensorID;
}
 ...
 */
bool MPU6050::begin(bool setupWire) {
    if( setupWire ) {
        // Enable I2C
        Wire.begin();
    }

    uint8_t WHO_AM_I = read8(MPU6050_ADDRESS, MPU6050_WHO_AM_I);
...
void MPU6050::fillTempEvent(sensors_event_t *temp,
                            uint32_t timestamp) {
...
/*!
  ...
  */
Adafruit_Sensor *MPU6050::getTemperatureSensor(void) {
    return temp_sensor;
}
...
/*!
  ...
  */
Adafruit_Sensor *MPU6050::getAccelerometerSensor(void) {
    return accel_sensor;
}
...
/*!
  ...
  */
Adafruit_Sensor *MPU6050::getGyroSensor(void) { return gyro_sensor; }
